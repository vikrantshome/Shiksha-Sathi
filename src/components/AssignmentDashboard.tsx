  ...
  return (
    <>
      ...
      <div className="flex justify-end mb-6">
        <div className="bg-[#f0ede9] p-1 rounded-xl flex gap-1 border border-[#c0c8c6]/30 shadow-sm">
          <button 
            onClick={() => setViewMode('list')}
            className={`px-5 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition-all ${viewMode === 'list' ? 'bg-[#12423f] text-white shadow-md' : 'text-[#707977] hover:text-[#1c1c1a]'}`}
          >
            List View
          </button>
          <button 
            onClick={() => setViewMode('worksheet')}
            className={`px-5 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition-all ${viewMode === 'worksheet' ? 'bg-[#12423f] text-white shadow-md' : 'text-[#707977] hover:text-[#1c1c1a]'}`}
          >
            Class Worksheet
          </button>
        </div>
      ...
      {viewMode === 'list' ? (
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex items-center justify-between bg-[#f0ede9] p-4 rounded-2xl border border-[#c0c8c6]/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-[#12423f] m-0">Cross-Assignment Analysis</p>
              </div>
            </div>
            <select
          ...
          <p className="text-[0.65rem] text-[#707977] text-center italic">
            Tip: This view compares student performance across multiple assignments. 
            Click on an individual assignment in List View to see question-level detail.
          </p>
        </div>
      )}
    </>
